...
local UI = Library:Create("[UPD] 💪 Scythe Simulator")
...
local dropdown = Library:CreateDropdown(Tab1, "How much Pet you wanna equip", options, function(Value)
 DupeAmount = Value
	end)

-- Create a button to demonstrate functionality
UI:CreateButton(Tab1, "Equip Infinite Pet", function()
